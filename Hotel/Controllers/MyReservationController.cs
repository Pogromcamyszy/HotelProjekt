...
namespace Hotel.Controllers
{
    public class MyReservationController : Controller
    {
        ...
        public MyReservationController(ReservationContext context)
        {
            _context = context;
        }
